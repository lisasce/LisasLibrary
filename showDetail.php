    ...
    ?>
        ...
        <div class='container '>
            <div class='row thumbnail mx-auto'>
                ...
                <img class='w-25 '  src='<?=$mediaQ['imageLink']?>' alt=\"Lights\" style='width:50%'>
                <div class='caption my-auto'>
                    <ul>
                        <li><strong>Title:</strong> <?=$mediaQ['title']?> </li>
                        <li><strong>Type:</strong> <?=$mediaQ['type']?></li>
                        <li><strong>Category:</strong> <?=$mediaQ['category']?></li>
                        <li><strong>Description:</strong> <?=$mediaQ['description']?></li>
                        <li><strong>Author's First Name:</strong> <?=$mediaQ['firstName']?></li>
                        <li><strong>Author's Last Name:</strong> <?=$mediaQ['lastName']?></li>
                        <li><strong>Publication Year:</strong> <?=$mediaQ['publishDate']?></li>
                        <li><strong>Publisher: </strong><?=$mediaQ['name']?></li>
                        <li><strong>ISBN:</strong> <?=$mediaQ['ISBN']?></li>
